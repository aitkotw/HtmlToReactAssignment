    ...
    <div className="App">
      <header className="header-area">
        ...
        >
          ...
          <div className="header-shape">
            <img
              src={require("./assets/images/header-shape.svg").default}
              alt="shape"
            />
          </div>
        </div>
            ...
            <div className="col-lg-4 col-md-7 col-sm-9">
              <div className="single-pricing pro mt-40">
                <div className="pricing-baloon">
                  <img
                    src={require("./assets/images/baloon.svg").default}
                    alt="baloon"
                  />
                </div>
      ...
      <section id="call-to-action" className="call-to-action">
        <div className="call-action-image">
          <img
            src={require("./assets/images/call-to-action.png")}
            alt="call-to-action"
          />
        </div>
          ...
          <div className="row">
            <div className="col-md-3 col-6">
              <div className="single-client mt-30 text-center">
                <img
                  src={require("./assets/images/client_logo_01.png")}
                  alt="Logo"
                />
              </div>
            </div>
            <div className="col-md-3 col-6">
              <div className="single-client mt-30 text-center">
                <img
                  src={require("./assets/images/client_logo_02.png")}
                  alt="Logo"
                />
              </div>
            </div>
            <div className="col-md-3 col-6">
              <div className="single-client mt-30 text-center">
                <img
                  src={require("./assets/images/client_logo_03.png")}
                  alt="Logo"
                />
              </div>
            </div>
            <div className="col-md-3 col-6">
              <div className="single-client mt-30 text-center">
                <img
                  src={require("./assets/images/client_logo_04.png")}
                  alt="Logo"
                />
              </div>
            </div>
